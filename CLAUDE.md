...
This project is indexed by GitNexus as **bioeolica-workflow** (281 symbols, 329 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
